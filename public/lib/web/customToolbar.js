let sheet = (function() {
 ...
 function editToolBar(){
  ...
  addElemFromSecondaryToPrimary('spreadNone', 'toolbarViewerMiddle')
  ...
  addElemFromSecondaryToPrimary('spreadOdd', 'toolbarViewerMiddle')

  //adding elements to right part of toolbar
//   addElemFromSecondaryToPrimary('spreadOdd', 'toolbarViewerRight')
