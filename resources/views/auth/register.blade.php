                                    ...
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="post" action="{{route('register')}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
                                                <x-input-error :messages="$errors->get('name')" class="mt-2" />
                                                {{-- <input type="text" required="" name="name" placeholder="Name" :value="old('name')" required autofoucs autocomplete="name"> --}}
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                {{-- <input required="" type="password" name="password_comfirmation" placeholder="Confirm password" required autocomplete="new-password"> --}}
                                                <x-input-label for="password_confirmation" :value="__('Confirm Password')" />
